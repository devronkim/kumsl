...
This mechanism has been integrated into Bitcore-Node-KUmsl which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/devronkim/insight-api-kumsl#web-socket-api](https://github.com/devronkim/insight-api-kumsl#web-socket-api)
* API: [https://github.com/devronkim/insight-api-kumsl#instantsend-transactions](https://github.com/devronkim/insight-api-kumsl#instantsend-transactions)
