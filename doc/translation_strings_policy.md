...
This document provides guidelines for internationalization of the KUmsl Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kumsl_en.ts` remains unchanged.
