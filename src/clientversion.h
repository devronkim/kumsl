...
//! These need to be macros, as clientversion.cpp's and kumsl*-res.rc's voodoo requires it
...
/**
 * kumsld-res.rc includes this file, but it cannot cope with real c++ code.
