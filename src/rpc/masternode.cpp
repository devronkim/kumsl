...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner KUmsl address\n"
            "  payee          - Print the masternode payout KUmsl address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting KUmsl address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "kumsl",               "masternode",             &masternode,             true,  {} },
    { "kumsl",               "masternodelist",         &masternodelist,         true,  {} },
    { "kumsl",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "kumsl",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "kumsl",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "kumsl",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
