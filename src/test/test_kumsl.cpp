...
#define BOOST_TEST_MODULE KUmsl Test Suite

#include "test_kumsl.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kumsl_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
