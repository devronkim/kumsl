    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KUMSL-light"), QVariant("light"));
    ui->theme->addItem(QString("KUMSL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("KUMSL-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("KUMSL-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("KUMSL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KUMSL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KUMSL-traditional"), QVariant("trad"));
