// Copyright (c) 2014-2018 The KUmsl Core developers
...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all KUmsl related functionality
...
/*
    ...
    allow endless transaction that would bloat KUmsl and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all KUmsl specific functionality
