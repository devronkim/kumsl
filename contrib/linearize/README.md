# Linearize
Construct a linear, no-fork, best version of the KUmsl blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install kumsl_hash

https://github.com/devronkim/kumsl_hash
...
JSON-RPC server. Running `kumsld` or `kumsl-qt -server` will be sufficient.
...
* `input`: kumsld blocks/ directory containing blkNNNNN.dat
